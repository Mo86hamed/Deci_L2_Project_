...
def set_voice():
    ...
    print("\n")
    print("""HINT!!!
    this game has turtle draw at end if you want to restart the game
    first you want to exit the turtle drawing
    it will run with you the first time but the second one it won't""")
    print("\n")
    print("\n")
    print("\n")
...
def story():
    ...
    print(".")
    time.sleep(1)
    print("""The ship's crew announces...
        that it has discovered a breach in the ship""")
    speak("""The ship's crew announces
        that it has discovered a breach in the ship""")
    time.sleep(1)
    print("""Panic and fear filled the place
        the ship's crew tried to calm the situation""")
    speak("""Panic and fear filled the place
        the ship's crew tried to calm the situation""")
    time.sleep(1)
...
# choice NO. 1 is talking about that you will help your self.
    if choice == '1':
        score += 20
        time.sleep(2)
        ...
        time.sleep(1)
        print("The sun is rising you woke up from your sleep cause of the sun")
        speak("The sun is rising you woke up from your sleep cause of the sun")
        time.sleep(2)
        ...
        time.sleep(1)
        print("""You found that you have enough
            food, water, and soft drink enough for one person for two weeks""")
        speak("""You found that you have enough
            food, water, and soft drink enough for one person for two weeks""")
        time.sleep(2)
        ...
        time.sleep(1)
        print("""At the last moment and before giving up....
            you finally catch a fish""")
        speak("""At the last moment and before giving up,
            you finally catch a fish""")
        time.sleep(2)
        ...
        time.sleep(1)
        print("""But you remembered that at the beginning of the day,
            you had found tools to desalinate seawater""")
        speak("""But you remembered that at the beginning of the day,
            you had found tools to desalinate seawater""")
        time.sleep(2)
        print("""The next day....
            you look for a ship or somebody who might help you!""")
        speak("""The next day,
            you look for a ship or somebody who might help you!""")
        time.sleep(2)
        score += 40
        ...
        time.print("Thinking what would you do")
        ...
        last_bullet = input("""
        Either the first choice 1: you won't shoot the last bullet
        Or
...
# here the player will win the game
        if last_bullet == "1":
            ...
            time.sleep(1)
            print("""You took the chance, reloaded your bullet...,
                and finally the ship's crew saw you and helped you 🚢⚓👨‍✈""")
            speak("""You took the chance, reloaded your bullet,
                and finally the ship's crew saw you and helped you """)
            time.sleep(2)
            score += 110
...
# in this the player will lose the game
            ...
            time.sleep(1)
            print("""Now you are alone in the middle of the sea....
                only darkness and cold""")
            speak("""Now you are alone in the middle of the sea
                only darkness and cold""")
            time.sleep(1)
            ...
            time.sleep(2)
            print("""You don't know what to be afraid of:
                the dark, the cold, loneliness,
                ocean monsters, madness, or... or what""")
            speak("""You don't know what to be afraid of:
                the dark, the cold, loneliness,
                ocean monsters, madness, or... or what""")
            time.sleep(2)
            print("Now u lost everything and you don't have anything to lose")
            speak("Now u lost everything and you don't have anything to lose")
            time.sleep(1)
...
# choice NO. 2 is talking about that you will help your family.
# choice = choice_story()
        ...
        print("""the sun is rising
            You and your family woke up from your sleep, cause of the sun""")
        speak("""the sun is rising
            You and your family woke up from your sleep, cause of the sun""")
        time.sleep(1)
        ...
        speak("You started exploring the lifeboat")
        time.sleep(1)
        print("""you found that you have enough food, water and soft drinks
            Enough for you and your family for 5 days.""")
        speak("""you found that you have enough food, water and soft drinks
            Enough for you and your family for 5 days.""")
        time.sleep(1)
        print("You are stuck in the middle of the sea")
        speak("You are stuck in the middle of the sea")
        ...
        time.sleep(2)
        print("""you cooked it
            and you start to eat the fish with your family happily""")
        speak("""you cooked it
            and you start to eat the fish with your family happily""")
        time.sleep(2)
        ...
        print(".")
        time.sleep(1)
        predestination = input("""you have two choices :
        1 - don't help your family and wait till it go
        2 - you will attack it and try to help you family\n""")
...
# here the player will win the game
            ...
            time.sleep(1)
            print("""the next day.....
                and you are give a look for a ship or
                somebody who might help you!""")
            speak("""the next day
                and you are give a look for a ship or somebody
                who might help you!""")
            time.sleep(2)
            print("you found a ship.!! ")
            speak("you found a ship.!! ")
...
# choice NO. 2 is talking about that you will
# try to help the largest number of passengers
    elif choice == "3":
        time.sleep(2)
        print("after thinking")
        speak("after thinking")
        time.sleep(1)
        print("""you chose that
            You will try to help The largest number of passengers """)
        speak("""you chose that
            You will try to help The largest number of passengers """)
        time.sleep(1)
        print("you found the lifeboat⛵🚤")
        speak("you found the lifeboat")
        time.sleep(1)
        print("""After doing your best,
            you and other passengers managed to survive""")
        speak("""After doing your best,
            you and other passengers managed to survive""")
        time.sleep(1)
        print("after period of time")
        speak("after period of time")
        ...
        speak("it's the morning")
        time.sleep(1)
        print("""the sun is rising and You woke up from your sleep,
            cause of the sun""")
        speak("""the sun is rising and You woke up from your sleep,
            cause of the sun""")
        time.sleep(2)
        ...
        speak("You started exploring the lifeboat")
        time.sleep(1)
        print("""you found that you have enough food,
            water and soft drinks Enough for you and your family for 2 days""")
        speak("""you found that you have enough food,
            water and soft drinks Enough for you and your family for 2 days""")
        time.sleep(2)
        print("You are stuck in the middle of the sea")
        speak("You are stuck in the middle of the sea")
        ...
        time.sleep(2)
        print("""you and other passengers made a great job,
            you cached a lot of fish""")
        speak("""you and other passengers made a great job,
            you cached a lot of fish""")
        time.sleep(2)
        print("""you cooked it
            and you start to eat the fish with your family happily""")
        ...
        time.sleep(1)
        monster = input("""you have two choice:
1 - you and the other men won't do anything
or
...
# here the player will win the game..
            ...
            time.sleep(1)
            print("""soon..........
                you think why you don't write on the beach big 'S.O.S' word""")
            speak("""soon..........
                you think why you don't write on the beach big 'S O S' word""")
            time.sleep(2)
            print(".")
...
# https://www.google.com/search?q=how+can+make+sound+
# in+python+that+speak&sca_esv=1aa700937aa37790&sca_upv=1&rlz=1C1YTUH_
# arEG1059EG1059&sxsrf=ADLYWIKgB5Uy6sqxkuBuJS7bvT4JqU1lDQ%3A17207558168
# 65&ei=aKaQZqzGNOeXhbIPypWF4AM&ved=0ahUKEwismtb5yqCHAxXnS0EAHcpKATwQ4dUDCA8&uact=5&oq=how+can+m
# ake+sound+in+python+that+speak&gs_lp=Egxnd3Mtd2l6LXNlcnAiJ2hvdyBjYW4gbWFrZSBzb3VuZCBpbiBweXRob
# 24gdGhhdCBzcGVha0gAUABYAHAAeACQAQCY
# AQCgAQCqAQC4AQPIAQCYAgCgAgCYAwCSBwCgBwA&sclient=gws-wiz-serp
# then i asked chat gpt to give me an example
# to know how it run and learn how it works ((the sound)).
